...
class CATSegHead(nn.Module):
    ...
    def forward(self, features, guidance_features, prompt=None, gt_cls=None, adjectives=None):
        """
        Arguments:
            img_feats: (B, C, HW)
        ...
        return self.predictor(img_feat, guidance_features, prompt, gt_cls, adjectives)