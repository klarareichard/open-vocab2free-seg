...
class CATSegHead(nn.Module):
    ...
    def forward(self, features, guidance_features, prompt=None, gt_cls=None, adjectives=None, mapped_class_names = None, original_class_names = None):
        """
        Arguments:
            img_feats: (B, C, HW)
        ...
        return self.predictor(img_feat, guidance_features, prompt, gt_cls, adjectives, mapped_class_names, original_class_names)